...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'D:\Python\date_pre_solve\RSDDs\data_rail\images')
    parser.add_argument('--source_xml_path', type=str, default=r'D:\Python\date_pre_solve\RSDDs\data_rail\xml_labels')
    parser.add_argument('--save_img_path', type=str, default=r'D:\Python\date_pre_solve\RSDDs\data_rail\try_img')
    parser.add_argument('--save_xml_path', type=str, default=r'D:\Python\date_pre_solve\RSDDs\data_rail\try_label')
